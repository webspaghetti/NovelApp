    ...
    return (
        <div className="flex max-sm:flex-col flex-row max-sm:items-start justify-center items-center max-sm:gap-3 gap-8 border-b-[3px] border-gray-700 pb-4">
            <div className="w-1/2 max-sm:w-full animate-pulse">
                <div className="bg-gray-700 rounded-lg h-[465px] w-[350px] m-auto" />
            </div>

            <div className="flex flex-col justify-center items-start md:w-1/3 max-sm:w-full gap-1">
                <div className="flex flex-row items-center sm:gap-2 w-full">
                    <div className="h-8 w-[90px] bg-gray-700 rounded-full animate-pulse mb-4" />
                    <div className="h-6 w-6 bg-gray-700 rounded-full animate-pulse mb-4" />
                </div>

                <div className="h-9 w-3/4 bg-gray-700 rounded-lg animate-pulse mb-2" />
                <div className="h-7 w-1/2 bg-gray-700 rounded-lg animate-pulse mb-2" />
                <div className="h-5 w-2/3 bg-gray-700 rounded-lg animate-pulse" />

                <div className="h-12 w-52 bg-gray-700 rounded-lg animate-pulse my-2" />
