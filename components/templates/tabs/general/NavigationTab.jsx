                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 w-full">
                                    <input
                                        type="color"
                                        value={settings.navbar.nav_color}
                                    ...
                                    <button className="text-secondary p-2 hover:scale-100 border-2"
                                            onClick={() => handleRestore("navbar.nav_color")}>
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <input
                                        type="color"
                                        value={settings.navbar.text_color}
                                    ...
                                    />
                                    <button className="text-secondary p-2 hover:scale-100 border-2"
                                            onClick={() => handleRestore("navbar.text_color")}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                             className="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
                                            <path fillRule="evenodd"
                                                  d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2z"/>
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <input
                                        type="color"
                                        value={settings.navbar.outline_color}
                                    ...
                                    />
                                    <button className="text-secondary p-2 hover:scale-100 border-2"
                                            onClick={() => handleRestore("navbar.outline_color")}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                             className="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
                                            <path fillRule="evenodd"
                                                  d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2z"/>
