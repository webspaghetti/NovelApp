        ...
        <main className="relative top-20">
            <div className={'flex flex-col md:flex-row justify-center items-center gap-8 border-b-3 border-b-gray-400 pb-4'}>
                ...
                <div className="w-full md:w-1/3">
                    <Image src={`/thumbnails/${novel.formatted_name}.jpg`} alt={`${novel.name} thumbnail`} width={350} height={350} quality={100} className="select-none rounded-lg shadow-lg" draggable="false" />
                </div>
