...
export default function Register() {
    ...
    return (
        <div className={"max-w-md mx-auto my-24 p-6 bg-black/40 border-2 border-secondary/10 shadow-lg rounded-lg"}>
            <h1 className={"max-sm:text-2xl text-3xl font-bold text-center mb-6 text-secondary link_outline select-none"}>Register</h1>
            <form onSubmit={handleSubmit}>
                <div className={"mb-6"}>
                    <label className={"block max-sm:text-base text-lg font-semibold mb-2 text-secondary"}>Username</label>
                ...
                <div className={"mb-6"}>
                    <label className={"block max-sm:text-base text-lg font-semibold mb-2 text-secondary"}>Password</label>
                    <div className={"border border-gray-700 bg-navbar rounded-lg px-2 py-2 focus-within:border-primary"}>
                        <input
                            type="password"
                            value={password}
                ...
                <div className={"mb-6"}>
                    <label className={"block max-sm:text-base text-lg font-semibold mb-2 text-secondary"}>Confirm Password</label>
                    <div className={"border border-gray-700 bg-navbar rounded-lg px-2 py-2 focus-within:border-primary"}>
                        <input
                            type="password"
                ...
                >
                    {isLoading ? <CircularProgress sx={{color: "#FAFAFA"}} size={28} thickness={8} /> : 'Register'}
                </button>
            </form>
