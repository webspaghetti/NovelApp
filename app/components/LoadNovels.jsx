        ...
        novels.map((novel) => (
            ...
            <div key={novel.id} className={"card glassy-animation"}>
                <Link href={`/${novel.formatted_name}`}>
                    <Image src={novel.image_url} alt={`${novel.name} thumbnail`} width={1000} height={1000} quality={100} className={"w-full h-96 sm:h48 object-cover select-none img"} draggable="false"/>
                    <div className="m-4">
