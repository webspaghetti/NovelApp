            ...
            return (
                <div key={novel.id} className={"card glassy-animation"} style={{ height: "auto" }}>
                    <Link href={`/${novel.formatted_name}`}>
                        <Image src={novel.image_url_alternative ? novel.image_url_alternative : novel.image_url} alt={`${novel.name} thumbnail`} width={1000} height={1000} quality={100} className={"w-full h-[20rem] md:h-96 max-sm:h-52 object-cover select-none img"} draggable="false" priority={true} />
