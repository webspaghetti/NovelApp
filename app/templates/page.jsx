                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div className="flex flex-col">
                                ...
                                <EditTemplate userId={session.user.id} userTemplateList={userTemplateList} />
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div className="flex flex-col">
                                ...
                                <button
                                    ...
                                    className="group relative px-4 py-6 sm:px-6 sm:py-8 text-sm text-gray-400 flex flex-col items-center justify-center bg-main_background border-2 border-dashed border-gray-700 rounded-xl hover:border-green-500 hover:bg-gray-800/50 transition-all duration-300"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-12 sm:size-16 mb-2 sm:mb-3 group-hover:scale-105 group-hover:text-green-500 transition-all duration-300">
